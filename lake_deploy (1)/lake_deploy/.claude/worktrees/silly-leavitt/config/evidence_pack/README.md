...
- Provide cross-check results and confidence signals.
- Support external audits without requiring access to the UI.

The JSON Schema is in `evidence_pack_schema.json`.
