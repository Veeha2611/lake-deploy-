...
The earlier path (captured in `Downloads/owned thread resolve.txt`) bucketed from billed customer IDs:
...
### 2) “Owned thread resolve” notes (definition breakdown)
- `/Users/patch/Downloads/owned thread resolve.txt`
