...
8. Keep the positive continuity note near the top: the pipeline is automated and vetted; the only open action is running GLENTRY with the corrected scope, so any new session can proceed from this status without thinking the work is blocked.
