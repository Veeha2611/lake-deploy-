...
: "${INTACCT_SENDER_PASSWORD:?INTACCT_SENDER_PASSWORD missing}"
...
: "${INTACCT_USER_PASSWORD:?Missing user password for env=$ENV_NAME (set INTACCT_USER_PASSWORD_${ENV_NAME^^} or INTACCT_USER_PASSWORD)}"
